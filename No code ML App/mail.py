...
def sendReport(imagedir, processName, receiver, cc = []):
    ...
    sender_email = "guhancasillas@gmail.com"
    receiver_email = receiver.split(',')
    cc_email = cc.split(',')
    password = "yes yes yes"

    message = MIMEMultipart("mixed")
    message["Subject"] = processName + " - Nocode ML Report Generated by Guhanesvar's Nocode ML App"
    ...
    html = """    <html>
    <body>
        <p><h1><u> Nocode ML - {processName} Process Completed </u></h1><p>
        <p><strong> Time Report Generated:  {date} </strong></p>
        <p>Dear All,</p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;The  Nocode ML process is completed.</p>
